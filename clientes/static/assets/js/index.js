...
// 	type: 'doughnut',
// 	data: {
// 		labels: ["Propuesta Enviada", "En Negociación", "Pendiente por Contactar", "Imposible Contactar", "Cerrado - Exitoso", "En Proceso", "En Espera de Pago", "En Proceso de Evaluación"],
// 		datasets: [{
// 			label: "Device Users",
// 			backgroundColor: ["#3498db", "#2980b9", "#1abc9c", "#9b59b6", "#3498db", "#2980b9", "#1abc9c", "#9b59b6"],
// 			data: [15, 10, 5, 8, 20, 12, 7, 28]
// 		}]
// 	  },
// 	  options: {
